...
class Responder extends Model
{
    ...
    protected $fillable = ['responder_id', 'user_id', 'responder_code', 'created_by_admin_id', 'team_id', 'username', 'password_hash', 'full_name', 'title', 'contact_number', 'emergency_contact_name', 'emergency_contact_number', 'date_of_birth', 'gender', 'blood_type', 'address', 'skills', 'training_notes', 'certification_reference', 'equipment_notes', 'is_validated', 'is_deployed', 'duty_status', 'last_active_at'];
