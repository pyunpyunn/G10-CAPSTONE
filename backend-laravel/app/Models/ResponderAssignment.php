...
class ResponderAssignment extends Model
{
    ...
    protected $fillable = ['assignment_id', 'assignment_code', 'responder_id', 'team_id', 'disaster_id', 'affected_area_id', 'household_id', 'status_log_id', 'assigned_area', 'route_notes', 'priority_level', 'dispatch_notes', 'created_by_admin_id', 'status', 'assigned_at', 'accepted_at', 'en_route_at', 'arrived_at', 'completed_at', 'outcome_notes'];
